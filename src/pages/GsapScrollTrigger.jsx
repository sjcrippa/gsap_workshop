...
// ScrollTrigger es un plugin, lo que quiere decir que primero debes inicializarlo para luego poder usarlo, de la siguiente forma:
...
const GsapScrollTrigger = () => {
  ...
  useGSAP(() => {
    const boxes = gsap.utils.toArray(scrollRef.current.children) // asi se obtiene un children usando useRef.
